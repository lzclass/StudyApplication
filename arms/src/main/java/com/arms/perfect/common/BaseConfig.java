...
public final class BaseConfig {
    ...
    public static final String CACHE_LOG_DIR = "http_log_cache";//默认异常LOG缓存目录
    ...
    public static final int WRITE_TIME_OUT = 30;//默认写入超时时间（秒）
    public static final int READ_TIME_OUT = 30;//默认读取超时时间（秒）
    ...
    public static final int DEFAULT_RETRY_COUNT = 0;//断连默认重试次数
    public static final int DEFAULT_RETRY_DELAY_MILLIS = 3;//断连默认重试间隔时间（秒）
